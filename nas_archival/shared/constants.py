...
MISSING_PREFIX = '003'
REPLIES_TO_MEDIA_QUERY_TYPE = 'REPLIES TO MEDIA QUERY'
REPLIES_TO_MEDIA_QUERY_PREFIX = '004'

ARTICLE_TYPES_MAP = {
    NEWS_RELEASES_TYPE: NEWS_RELEASES_PREFIX,
    SPEECHES_TYPE: SPEECHES_PREFIX,
    OTHERS_TYPE: OTHERS_PREFIX,
    REPLIES_TO_MEDIA_QUERY_TYPE: REPLIES_TO_MEDIA_QUERY_PREFIX,
...
GLOBAL_SPEECH_LOGO_FILENAME = 'SPEECH_LOGO_FILENAME'
GLOBAL_SAVE_PDF_COUNTER = 'SAVE_PDF_COUNTER'
GLOBAL_LOGO_PATH = os.path.join(FILE_DIR, 'LOGO.png')
GLOBAL_SPEECH_LOGO_PATH = os.path.join(FILE_DIR, 'SPEECH_LOGO.png')
